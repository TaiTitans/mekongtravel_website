...
<template>
  <div class="footer mt-2">
    <div class="bg-gray-300">
      ...
      >
        <div class="p-5">
          <h3 class="font-bold text-xl text-cyan-600">MekongTravel</h3>
        </div>
        <div class="p-5">
    ...
    <div class="bg-white pt-2">
      <div
        class="flex px-2 m-auto pt-3 border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center"
      >
        <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
          <a href="/#" class="w-6 mx-1">
            <svg
              class="fill-current cursor-pointer text-gray-500 hover:text-white"
              width="100%"
              height="100%"
              viewBox="0 0 24 24"
              version="1.1"
        ...
        <div class="my-5">MekongTravel © Copyright 2024. All Rights Reserved.</div>
      </div>
    </div>
  </div>
</template>
