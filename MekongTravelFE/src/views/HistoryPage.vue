...
<template>
  ...
  <div>
    ...
    <div class="gomsu_component flex flex-col gap-2.5 items-start justify-start relative">
    <div class="shrink-0 w-[1439px] h-[750px] static">
      <div class="w-[1439px] h-[750px] absolute left-0 top-0"></div>
      <div
        class="flex flex-col gap-2.5 items-start justify-start absolute left-[71px] top-px"
      >
        <div class="shrink-0 w-[1360px] h-[748px] static">
          <img
            class="rounded-tl-[250px] rounded-tr-[250px] w-[400px] h-[542.4px] absolute left-0 top-[131px]"
            style="object-fit: cover"
            src="../assets/img/historypage/gomsu1.png"
          />
          <img
            class="rounded-tl-[150px] rounded-br-[140px] w-[280px] h-[350px] absolute left-[274px] top-[398px]"
            style="object-fit: cover"
      ...
      <div
        class="flex flex-row gap-2.5 items-start justify-start absolute left-[553px] top-[70px]"
      >
        <div class="shrink-0 w-[535px] h-[610px] static">
          ...
          >
            ...
            thăng trầm, gốm sứ Việt Nam có lúc phát triển mạnh mẽ nhưng cũng gặp
            không ít khó khăn.
          </div>
          <div
            class="text-[#554f3d] text-left font-['Cormorant-Regular',_sans-serif] text-xl font-normal absolute left-[260px] top-[470px] w-[416px]"
          >
            Có rất nhiều làng nghề vẫn tồn tại và phát triển cho đến ngày nay
            nhưng ngược lại cũng có những làng nghề dần lụi tàn, biến mất khỏi
            bản đồ gốm sứ Việt Nam.
          </div>
          <div
            class="text-[#554f3d] text-left font-['Cormorant-Regular',_sans-serif] text-xl font-normal absolute left-0 top-0 w-[416px]"
          >
            Để có được sự phát triển mạnh mẽ như ngày nay, gốm sứ Việt Nam đã
            trải qua hàng trăm năm xây dựng, bảo tồn, bảo tồn và phát triển. Dù
            trải qua bao biến cố, thăng trầm trong lịch sử nhưng những tinh hoa
            gốm sứ Việt Nam vẫn luôn giữ nguyên, luôn có sự đổi mới và để lại
            kho tàng những tác phẩm gốm độc đáo.
          </div>
        </div>
      </div>
    </div>
