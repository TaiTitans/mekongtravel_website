        ...
        <section class="bg-gray-100 h-full flex box-border justify-center items-center">
            <div class="bg-white shadow-xl rounded-2xl flex w-9/12 p-5 items-center form_login">
                <div class="md:w-1/2 px-8">
                    ...
                    <button
                        class="text-black bg-white border py-2 w-1/2 rounded-xl mt-5 flex justify-center items-center text-sm hover:scale-105 duration-300 hover:bg-[#60a8bc4f] font-medium">
                    ...
                    <div class="mt-10 border-b border-gray-500 py-5">
                        <a class="text-[#325285] underline"> Quên mật khẩu? </a>
                    </div>
