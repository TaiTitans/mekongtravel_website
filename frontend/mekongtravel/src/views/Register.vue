...
<template>
    <body class="body_register">
        <section class="bg-gray-100 h-full flex box-border justify-center items-center">
            <div class="bg-white shadow-xl rounded-2xl flex w-9/12 p-5 items-center form_register">
                <div class="md:w-1/2 px-8">
                    ...
                    <form action="" class="flex flex-col gap-4">
                        <input class="p-2 mt-8 rounded-xl border" type="username" name="username" placeholder="Tên đăng nhập" require />
                        <input class="p-2 rounded-xl border" type="email" name="email" placeholder="Email" require />
                        <div class="relative flex items-center">
                            <input class="p-2 rounded-xl border w-full" type="text" name="otp" id="otp"
                                placeholder="Nhập mã OTP" require />
                            <button class="bg-[#002D74] text-white px-4 rounded-xl ml-2 hover:scale-105 duration-300 hover:bg-[#206ab1] font-medium"
                                type="button">Send OTP</button>
                        </div>

                        <div class="relative">
                            <input class="p-2 rounded-xl border w-full" type="password" name="passwordRegister" id="passwordRegister"
                        ...
                        <input class="p-2 rounded-xl border" type="password" name="confirmPassword" id="confirmPassword"
            placeholder="Nhập lại mật khẩu" require />
                ...
                <div class="md:block hidden w-1/2">
                    <img class="rounded-2xl max-h-[1600px]" src="../assets/img/background_register.png"
